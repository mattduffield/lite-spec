!function(e, t) {
  ...
  , function(e, t, n) {
      ...
      (function(e) {
          ...
          ;
          !function(c, o) {
              "object" === i(t) && "object" === i(e) ? e.exports = o() : (s = [],
              n = o,
              ...
              return function(e) {
                  ...
                  function s(e, t) {
                      var n = {};
                      for (var s in e)
                          t.indexOf(s) >= 0 || Object.prototype.hasOwnProperty.call(e, s) && (n[s] = e[s]);
                      return n
                  }
                  ...
                  : function(e) {
                    ...
                    , E = t.force = function(e, t) {
                      ...
                      x.innerHTML = '<div class="' + r.classes.textboxInner + '">' + a + "</div>";
                    ...
                    , T = t.confirm = function(e, t, n) {
                      ...
                      E.innerHTML = '<div class="' + r.classes.textboxInner + '">' + s + "</div>";
                    ...
                    , M = function(e, t, n) {
                      ...
                      H.innerHTML = '<div class="' + r.classes.textboxInner + '">' + i + "</div>";
                      ...
                      E.allowed && (S.oninput = function() {
                          ...
                          if (Array.isArray(E.allowed)) {
                              for (var t = "", n = E.allowed, s = 0; s < n.length; s++)
                                  "an" === n[s] ? t += "0-9a-zA-Z" : "a" === n[s] ? t += "a-zA-Z" : "n" === n[s] && (t += "0-9"),
                                  "s" === n[s] && (t += " ");
                              e = new RegExp("[^" + t + "]","g")
                          } else
                              "object" === a(E.allowed) && (e = E.allowed);
