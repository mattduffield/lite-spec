...
window.ls.handlePermExpression = handlePermExpression;
window.ls.handleIfExpression = handleIfExpression;
window.ls.handleAttributes = handleAttributes;
window.ls.parseDSL = parseDSL;